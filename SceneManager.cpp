...
void SceneManager::SetShaderMaterial(const std::string& materialTag)
{
	...
	for (const auto& material : m_objectMaterials)
	{
		if (material.tag == materialTag)
		{
			...
			return; // Material found, exit the function
		}
	}
...
void SceneManager::LoadSceneTextures()
{
	...
	bReturn = CreateGLTexture(
		"../../Utilities/textures/pavers.jpeg",
		"floor");
	bReturn = CreateGLTexture(
		"../../Utilities/textures/seamless-wood-texture-1.jpg",
		"table_top");
	bReturn = CreateGLTexture(
		"../../Utilities/textures/aluminium-brushed-metal-texture.jpg",
		"laptop");
	bReturn = CreateGLTexture(
		"../../Utilities/textures/gray-marble-texture.jpg",
		"mug");
	bReturn = CreateGLTexture(
		"../../Utilities/textures/laptop-screen.jpg",
		"screen");
...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("spotLight.position", 0.6f, 5.0f, 6.0f);
	m_pShaderManager->setVec3Value("spotLight.direction", 0.0f, -1.0f, -1.0f);
	m_pShaderManager->setFloatValue("spotLight.cutOff", cos(glm::radians(12.5f)));
	m_pShaderManager->setFloatValue("spotLight.outerCutOff", cos(glm::radians(15.0f)));
...
void SceneManager::RenderScene()
{
	...
	/****************************TABLE*******************************/
	scaleXYZ = glm::vec3(9.0f, 0.3f, 3.0f);
	XrotationDegrees = 0.0f;
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	...
	/****************************FRONT LEFT LEG*********************/
	scaleXYZ = glm::vec3(0.7f, 3.0f, 0.5f);
	XrotationDegrees = 0.0f;
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(-4.0f, 1.5f, 6.0f);
	SetTransformations(scaleXYZ, XrotationDegrees, YrotationDegrees, ZrotationDegrees, positionXYZ);
	SetShaderTexture("table_top");
	SetShaderMaterial("wood");
	m_basicMeshes->DrawBoxMesh();
	...
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(-4.0f, 1.5f, 4.0f);
	SetTransformations(scaleXYZ, XrotationDegrees, YrotationDegrees, ZrotationDegrees, positionXYZ);
	SetShaderTexture("table_top");
	SetShaderMaterial("wood");
	m_basicMeshes->DrawBoxMesh();
	...
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(-3.0f, 3.1f, 4.0f);
	SetTransformations(scaleXYZ, XrotationDegrees, YrotationDegrees, ZrotationDegrees, positionXYZ);
	...
	/****************************LAPTOP SCREEN**********************/
	scaleXYZ = glm::vec3(2.0f, 0.1f, 1.2f);
	XrotationDegrees = 60.0f;
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(0.0f, 3.9f, 3.0f);
	SetTransformations(scaleXYZ, XrotationDegrees, YrotationDegrees, ZrotationDegrees, positionXYZ);
	...
	scaleXYZ = glm::vec3(1.9f, 0.1f, 1.1f);
	XrotationDegrees = 60.0f;
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(0.0f, 3.90f, 3.1f);
	SetTransformations(scaleXYZ, XrotationDegrees, YrotationDegrees, ZrotationDegrees, positionXYZ);
	...
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(0.0f, 3.12f, 4.8f);
	SetTransformations(scaleXYZ, XrotationDegrees, YrotationDegrees, ZrotationDegrees, positionXYZ);
	SetShaderTexture("laptop");
	SetShaderMaterial("glass");
	m_basicMeshes->DrawPlaneMesh();
